    ...
    <div className="min-h-screen bg-white font-inter text-gray-800">
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-6 z-10">
          ...
          <p className="text-lg sm:text-xl max-w-3xl mx-auto opacity-95 text-gray-500 drop-shadow-lg">
            Sitara Petroleum provides a complete range of premium motor fuels
            designed to maximise performance, efficiency, and long-term
            reliability for personal vehicles, fleets, and heavy-duty industrial
            applications. Each drop of our fuel is tested, refined, and
            distributed with a commitment to purity and quality.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Title
              ...
              subtitle="Sitara Petroleum is committed to delivering <b>uncompromised purity and performance</b> with every litre of fuel we provide."
              align="left"
            />
      ...
      <section className="py-20 text-center bg-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <Title
            ...
            subtitle="Whether you are refuelling your family car, powering a fleet, or running industrial operations, Sitara Petroleum fuels are engineered for <b>performance, protection, and peace of mind</b>—trusted throughout Pakistan."
            className="mt-16"
          />
        </div>
      </section>
