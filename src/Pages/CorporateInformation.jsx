  ...
  return (
    <div className="min-h-screen bg-white px-4 sm:px-8 md:px-12 lg:px-20 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <Title title="Discover Our Corporate Structure" subtitle="" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-md transition">
          ...
          <ul className="text-gray-600 text-sm space-y-2">
            <li>
              <strong>Registered Name:</strong> Sitara Petroleum Services (Pvt)
              Ltd.
            </li>
            <li>
        ...
        {/* Bankers */}
        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-md transition">
          <h3 className="text-xl font-semibold text-gray-900 mb-3">Bankers</h3>
          <ul className="text-gray-600 text-sm space-y-2">
        ...
        {/* Auditors */}
        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:shadow-md transition">
          <h3 className="text-xl font-semibold text-gray-900 mb-3">Auditors</h3>
          <ul className="text-gray-600 text-sm space-y-2">
      ...
      <div className="text-center mt-16">
        ...
        <p className="text-gray-600 max-w-lg mx-auto mb-6">
          For business inquiries or corporate communication, please reach out to
